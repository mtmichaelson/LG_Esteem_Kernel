...
void lge_marimba_codec_reg_write(u8 reg,u8 mask,u8 val)
{
	pr_info("%s: write reg %x val %x\n", __func__, reg, val);
	adie_codec_write(reg, mask, val);
}
EXPORT_SYMBOL(lge_marimba_codec_reg_write);
...
/*BEGIN: 0012068 ehgrace.kim@lge.com 2010-12-09*/
/*MOD 0012068:change to enable High pass filter as per HW request*/
/*BEGIN: 0011749 kiran.kanneganti@lge.com 2010-12-02*/
/*MOD 0011749:High pass filter Bypass as per HW request*/
	/* dither delay selected and dmic gain stage bypassed */
	adie_codec_write(0x8F, 0xFF, 0x44);
	/*adie_codec_write(0x8F, 0xFF, 0x47);*/
/* END: 0011749 kiran.kanneganti@lge.com 2010-12-02 */	
/* END: 0012068 ehgrace.kim@lge.com 2010-12-09*/
}
