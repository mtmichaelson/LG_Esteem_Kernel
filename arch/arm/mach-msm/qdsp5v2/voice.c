...
/*ADD 0011955: QDSP Rx Mute support in voice call*/						
			v->dev_rx.mute =
				evt_payload->voc_vm_info.dev_vm_val.mute;
/* END: 0011955 kiran.kanneganti@lge.com 2010-12-07 */				
		}
		/* send device info */
		voice_cmd_device_info(v);
		break;
...
/*BEGIN: QCT_PATCH_2030_05_06 ehgrace.kim@lge.com 2011-01-10*/
#if 0
...
/*BEGIN: 0011955 kiran.kanneganti@lge.com 2010-12-07*/
/*ADD 0011955: QDSP Rx Mute support in voice call*/				
				v->dev_rx.mute = v->default_vol_val;
/* END: 0011955 kiran.kanneganti@lge.com 2010-12-07 */				
				voice_cmd_device_info(v);
#endif
/*END: QCT_PATCH_2030_05_06 ehgrace.kim@lge.com 2011-01-10*/
				/* send device change to modem */
				voice_cmd_change();
				mutex_unlock(&voice.voc_lock);
				rc = wait_event_interruptible(
...
static int voice_cmd_device_info(struct voice_data *v)
{
	...
	if (v->network == NETWORK_WCDMA_WB)
		vol = v->min_rx_vol[VOC_WB_INDEX] +
			...
			v->min_rx_vol[VOC_WB_INDEX]) * v->dev_rx.volume)/75;
	else
		vol = v->min_rx_vol[VOC_NB_INDEX] +
			((v->max_rx_vol[VOC_NB_INDEX] -
			v->min_rx_vol[VOC_NB_INDEX]) * v->dev_rx.volume)/75;
...
/*ADD 0011955: QDSP Rx Mute support in voice call*/	
	...
	MM_DBG("rx_vol=%d, rx_sample=%d, rx_mute= %d \n", cmd.rx_volume, v->dev_rx.sample,cmd.rx_mute);
/* END: 0011955 kiran.kanneganti@lge.com 2010-12-07 */
	err = dalrpc_fcn_5(VOICE_DALRPC_CMD, v->handle, &cmd,
