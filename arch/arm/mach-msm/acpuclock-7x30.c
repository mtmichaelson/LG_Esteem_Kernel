...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 1804800, PLL_2, 3, 0, UINT_MAX, 1375, VDD_RAW(1375), &pll2_tbl[10]},
	{ 1, 1900800, PLL_2, 3, 0, UINT_MAX, 1400, VDD_RAW(1400), &pll2_tbl[11]},
	{ 1, 2016000, PLL_2, 3, 0, UINT_MAX, 1425, VDD_RAW(1425), &pll2_tbl[12]},
	{ 1, 2108000, PLL_2, 3, 0, UINT_MAX, 1450, VDD_RAW(1450), &pll2_tbl[12]},
	{ 0 }
};
